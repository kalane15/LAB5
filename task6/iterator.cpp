...
void iterator::advance(long long n) {
...
iterator iterator::operator+(long long n) const {
	iterator iter = *this;
...
iterator& iterator::operator+=(long long n) {
	advance(n);
	return *this;
}

iterator iterator::operator-(long long n) const { return *this + (-n); }

iterator& iterator::operator-=(long long n) { return *this += (-n); }
...
double& iterator::operator[](long long n) const { return *(*this + n); }