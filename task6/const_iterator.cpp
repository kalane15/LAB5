...
void const_iterator::advance(long long n) {
...
const_iterator const_iterator::operator+(long long n) const {
...
const_iterator& const_iterator::operator+=(long long n) {
	advance(n);
	return *this;
}
...
const double& const_iterator::operator[](long long n) const {
	return *(*this + n);
}